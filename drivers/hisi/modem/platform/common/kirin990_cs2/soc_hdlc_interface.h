...
#endif
#define SOC_HDLC_GET_SYSCTRL_ADDR() mdrv_misc_get_ip_baseaddr(BSP_IP_TYPE_SYSCTRL_MDM)
#define SOC_HDLC_SYSCTRL_STAT_OFFSET (0x620)
#define SOC_HDLC_SYSCTRL_STAT_BITPOS (2UL)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
