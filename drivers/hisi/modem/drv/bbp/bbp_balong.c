...
u32 bbpom_cmd[] = {
    0x1100, 0x1001, 0x1002, 0x1003, 0x1004, 0x1005, 0x1200, 0x1400, 0x1600,
    0x0,    0x200,  0x400,  0x600,  0x800,  0xa00,  0xc00,  0xe00
};
u32 bbpom_apscreg[] = { 0xac,  0xb4,  0xb8,  0x168, 0x16c, 0x1b8, 0x208, 0x240,
                        0x30c, 0x324, 0x360, 0x530, 0x534, 0x538, 0x53c, 0x540 };
...
void balong_bbp_get_om_info(int print_enable)
{
    ...
    if (sctrl_addr == NULL) {
        bsp_err("bsp_sysctrl_addr_byindex fail.\n");
        return;
    }
    ...
    for (i = 0; i < cmd_num; i++) {
        ...
        if (g_bbp_acore_om_info_addr != NULL) {
