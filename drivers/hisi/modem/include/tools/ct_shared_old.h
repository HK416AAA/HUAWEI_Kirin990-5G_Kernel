...
#ifndef CT_SHARED_OLD_H
#define CT_SHARED_OLD_H
...
enum BBIC_CAL_BAND_CFG_MODE_ENUM {
    ...
    BBIC_CAL_BAND_CFG_MODE_RESUME         = 0x02, /* 该Band配置RESUME    */
    BBIC_CAL_BAND_CFG_MODE_STANDBY        = 0x03, /* 该Band配置STANDBY   */
    BBIC_CAL_BAND_CFG_MODE_ON_IGNORE      = 0x04, /* 该Band配置激活不执行 */
    BBIC_CAL_BAND_CFG_MODE_OFF_IGNORE     = 0x05, /* 该Band配置关闭不执行 */
    BBIC_CAL_BAND_CFG_MODE_BUTT
};
typedef UINT8 BBIC_CAL_BAND_CFG_MODE_ENUM_UINT8;

/*
 * Description: 指示TX RX 配置顺序
 */
enum BBIC_CAL_TRX_CFG_ORDER_ENUM {
    BBIC_CAL_TRX_CFG_ORDER_TX_RX   = 0x00, /* 先配置TX Band，后配置Rx Band */
    BBIC_CAL_TRX_CFG_ORDER_RX_TX   = 0x01, /* 先配置RX Band，后配置Tx Band */
    BBIC_CAL_TRX_CFG_ORDER_BUTT
};
typedef UINT16 BBIC_CAL_TRX_CFG_ORDER_ENUM_UINT16;
...
/*
 * Description: SRS antenna port type
 */
enum BBIC_CAL_SRS_ANT_PORT_TYPE_ENUM {
    BBIC_CAL_SRS_ANT_PORT_0 = 0,
    BBIC_CAL_SRS_ANT_PORT_1 = 1,
    BBIC_CAL_SRS_ANT_PORT_2 = 2,
    BBIC_CAL_SRS_ANT_PORT_3 = 3,
    BBIC_CAL_SRS_ANT_PORT_TYPE_BUTT
};
typedef UINT16 BBIC_CAL_SRS_ANT_PORT_TYPE_ENUM_UINT16;

/*
 * Description: SRS ability type
 */
enum BBIC_CAL_SRS_ABILITY_TYPE_ENUM {
    BBIC_CAL_SRS_ABILITY_1T2R = 0,
    BBIC_CAL_SRS_ABILITY_1T4R = 1,
    BBIC_CAL_SRS_ABILITY_2T4R = 2,
    BBIC_CAL_SRS_ABILITY_TYPE_BUTT
};
typedef UINT16 BBIC_CAL_SRS_ABILITY_TYPE_ENUM_UINT16;
...
enum HFDPD_OPTION {
    HFDPD_OPTION_CAL  = 0x00, /* 进行校准 */
    HFDPD_OPTION_STOP = 0x01, /* 终止校准 */
    HFDPD_OPTION_WAIT_NEXT_MSG = 0x02, /* 等待下一次触发 */
    HFDPD_OPTION_BUTT
};
typedef UINT32 HfDpdOptionUint32;
...
typedef struct {
    ...
    UINT16                uhwRsv : 5;
    UINT8                 trxTasResIdx;       /* Rx下静态配置trxtas获取的trxtas资源池索引 */
    BBIC_CAL_TrxTas       trxTasPara;         /* Rx下仅使用antPort/ability和TrxTasEn，ability仅支持1T2R减少差损 */
    UINT8                 rsv[3];
...
typedef struct {
    ...
    BBIC_CAL_LO_RESULT_STRU        st8PhaseResult200M; /* B5010使用，B5000暂时不用 */
...
typedef struct {
    ...
    BAND_ENUM_UINT16      enBand;         /* Band No. */
    UINT16                uhwTxPathIndex; /* Tx Path Index */
    BANDWIDTH_ENUM_UINT16 etBandWidth;    /* Bandwidth ,reference BANDWIDTH_ENUM_UINT16 */
    BANDWIDTH_ENUM_UINT16 dpdBandWidth;   /* Bandwidth ,reference BANDWIDTH_ENUM_UINT16 */
    BANDWIDTH_ENUM_UINT16 etDpdBandWidth; /* Bandwidth ,reference BANDWIDTH_ENUM_UINT16 */
    VOS_UINT8             bitEtEn : 1;    /* ET使能，和NV共同控制校准 */
    VOS_UINT8             bitDpdEn : 1;   /* APT DPD使能，和NV共同控制校准 */
    VOS_UINT8             bitEtDpdEn : 1; /* ET DPD使能，和NV共同控制校准 */
    VOS_UINT8             rsv : 5;
    VOS_UINT8             rsv1[3];
    UINT32                uwFreqInfo;     /* Center Freq of each Band, the unit is kHz */
...
typedef struct {
    ...
    RAT_MODE_ENUM_UINT16               ratMode; /* 模式 */
    BBIC_CAL_TRX_CFG_ORDER_ENUM_UINT16 trxCfgOrder;    /*先配置tx还是先配置rx*/
...
typedef struct {
    UINT16                      modemId;
    UINT16                      ratMode;
} RFDEBUG_HFRX_PM2mPreSetReqPara;

typedef struct {
    UINT32                      errorCode;
} RFDEBUG_HFRX_PM2mPreSetIndPara;
...
typedef struct {
    INT16  txPower;     /* 功率 */
    UINT16 dpdPowerIdx; /* DPD校准的INDEX */
} HfTxApcCfgPower;
 ...
 */
typedef union {
    HfTxApcCfgPower     apcPower;        /* < Choice(POWER_CTRL_MODE_POWER) Power */
...
typedef struct {
    ...
    UINT16                uhwPatternNum;    /* < Pattern Num, aulTxPatternConfig[(usPatternNum + 31)/32] */
    BANDWIDTH_ENUM_UINT16 enBandWidth;      /* < Bandwidth */
    UINT16                hfDpdSourceIdx : 5; /* 高频DPD校准,当前频点对应的资源池索引 */
    UINT16                rsv1 : 11;
} BBIC_CAL_HfTxFreqConfig;
...
typedef struct {
     ...
     * BBIC_CAL_HfTxFreqConfig          freqCfg[n];         Any Freq cfg,    n = FreqNum
...
typedef struct {
    HfDpdOptionUint32 option;      /* 0:继续下一轮校准 1: 装备终止校准 2:等待下一次触发 */
    UINT16 flashDdrEn;  /* 1: 刷新DDR  0: 不刷新DDR，仅当option = 0时有效 */
...
/*
 * Description: Describes the client
 */
typedef struct {
    BBIC_CAL_MODEM_ID_ENUM_UINT16 enModemId; /**< Modem Id */
    RAT_MODE_ENUM_UINT16 enRatMode; /**< RAT Mode */
} BBIC_CAL_CLIENT_DESCR_STRU;

typedef struct {
    UINT32               uwCenterFreqInfo; /**< Center freqency, unit Khz. */
    BAND_ENUM_UINT16     enBand;           /**< Band Number */
    UINT16               uhwRsv;
} BBIC_CAL_FREQ_DESCR_STRU;
/*
 * Description: Configuration for RFHAL_TRXC_SrsSwitching
 */
typedef struct {
    BBIC_CAL_CLIENT_DESCR_STRU             stClient;           /**< Client descriptor */
    BBIC_CAL_FREQ_DESCR_STRU               stFreqDescr;        /**< Band and frequency */
    BBIC_CAL_SRS_ANT_PORT_TYPE_ENUM_UINT16 enAntPort;          /**< Logical antenna port for SRS Switching, Range:0~3. */
    BBIC_CAL_SRS_ABILITY_TYPE_ENUM_UINT16  enSrsAbility;       /**< SRS ability, 1T2R, 1T4R or 2T4R */
} BBIC_CAL_SRS_SWITCHING_STRU;

/*
 * Description: Msg cnf struct
 */
typedef struct {
    BBIC_CAL_SRS_SWITCHING_STRU stSrsSwitchPara; /* 配置SRS切换的参数 */
} BBIC_CAL_SRS_REQ_PARA_STRU;
...
typedef struct {
    ...
    UINT8  ucLogicAntIdx;
    UINT8  ucSrsSourceIdx;
    UINT16 uhwSrsType;
} BBIC_CAL_SRS_CNF_PARA_STRU;
