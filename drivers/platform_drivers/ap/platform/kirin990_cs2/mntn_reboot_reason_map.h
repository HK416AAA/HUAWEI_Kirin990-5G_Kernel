...
__REBOOT_REASON_MAP(ALOADER_PANIC, SUBTYPE)
__REBOOT_REASON_MAP(ALOADER_VWDT, VWATCHDOG)
__REBOOT_REASON_MAP(HM_PANIC, SUBTYPE)
__REBOOT_REASON_MAP(AP_S_VWDT, VWATCHDOG)
