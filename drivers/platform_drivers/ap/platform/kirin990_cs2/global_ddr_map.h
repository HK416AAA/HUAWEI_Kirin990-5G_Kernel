...
#if defined(CONFIG_PRODUCT_ARMPC)
...
#if defined(CONFIG_PRODUCT_CDC) || defined(CONFIG_CDC) || defined(CONFIG_RESERVED_MEM_CDC)
#define RESERVED_SECOS_PHYMEM_BASE 0x13600000
#define RESERVED_SECOS_PHYMEM_SIZE (0x2400000)
#define RESERVED_SECOS_EX_PHYMEM_BASE 0x15A00000
...
#define RESERVED_HIFI_PHYMEM_BASE 0x20000000
#define RESERVED_HIFI_DATA_PHYMEM_BASE 0x20F80000
#else
...
#if defined(CONFIG_PRODUCT_CDC) || defined(CONFIG_CDC)
#define RESERVED_IRIS_CMA_SIZE (0x9400000)
#else
...
#define RESERVED_SMEM_CMA_BASE 0xC0000000
#if defined(CONFIG_PRODUCT_CDC) || defined(CONFIG_CDC)
#define RESERVED_SMEM_CMA_SIZE 0xD800000
#else
